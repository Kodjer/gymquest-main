      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white font-medium hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {isGoogleLoading ? (
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-gray-800 text-gray-500">или войдите через email</span>
          </div>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center text-sm text-gray-600 dark:text-gray-400">
            Мы отправим вам ссылку для входа на почту
          </div>
        </form>
      </div>
    </div>
